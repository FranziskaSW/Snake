...
python3 /cs/usr/franziska/Snake/Snake.py \
    ...
    -l "/cs/usr/franziska/Snake/logs/linear_eps.log" \
    -o "/cs/usr/franziska/Snake/logs/linear_eps.out"
    
    
python3 /cs/usr/franziska/Snake/Snake.py \
    -P "Avoid(epsilon=0.1);Linear(gamma=0.2);Linear(gamma=0.4);Linear(gamma=0.6);Linear(gamma=0.8)" \
    -D 5000 -s 1000 -r 0 -plt 0.01 -pat 0.005 -pit 60 \
    -l "/cs/usr/franziska/Snake/logs/linear_ga.log" \
    -o "/cs/usr/franziska/Snake/logs/linear_ga.out"
...
python3 /cs/usr/franziska/Snake/Snake.py \
    ...
    -D 5000 -s 1000 -r 0 -plt 0.01 -pat 0.005 -pit 60 \
    -l "/cs/usr/franziska/Snake/logs/linear_lr.log" \
    -o "/cs/usr/franziska/Snake/logs/linear_lr.out"
