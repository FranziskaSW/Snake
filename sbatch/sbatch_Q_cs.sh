...
python3 /cs/usr/franziska/Snake/Snake.py \
    ...
    -D 20000 -s 2000 -r 0 -plt 0.05 -pat 0.01 -pit 60 \
    -l "/cs/usr/franziska/Snake/logs/Q_bs_16.log" \
    -o "/cs/usr/franziska/Snake/logs/Q_bs_16.out"
    
    
python3 /cs/usr/franziska/Snake/Snake.py \
    -P "Avoid(epsilon=0.1);Avoid(epsilon=0.1);Avoid(epsilon=0.1);Avoid(epsilon=0.1);MyPolicy(batch_size=32)" \
    -D 20000 -s 2000 -r 0 -plt 0.05 -pat 0.01 -pit 60 \
    -l "/cs/usr/franziska/Snake/logs/Q_bs_32.log" \
    -o "/cs/usr/franziska/Snake/logs/Q_bs_32.out"
    
    
python3 /cs/usr/franziska/Snake/Snake.py \
    -P "Avoid(epsilon=0.1);Avoid(epsilon=0.1);Avoid(epsilon=0.1);Avoid(epsilon=0.1);MyPolicy(batch_size=64)" \
    -D 20000 -s 2000 -r 0 -plt 0.05 -pat 0.01 -pit 60 \
    -l "/cs/usr/franziska/Snake/logs/Q_bs_64.log" \
    -o "/cs/usr/franziska/Snake/logs/Q_bs_64.out"


python3 /cs/usr/franziska/Snake/Snake.py \
    -P "MyPolicy(batch_size=8);MyPolicy(batch_size=16);MyPolicy(batch_size=32);MyPolicy(batch_size=32);MyPolicy(batch_size=64)" \
    -D 20000 -s 2000 -r 0 -plt 0.05 -pat 0.01 -pit 60 \
    -l "/cs/usr/franziska/Snake/logs/Q_bs_8-16-32-32-64.log" \
    -o "/cs/usr/franziska/Snake/logs/Q_bs_8-16-32-32-64.out"
